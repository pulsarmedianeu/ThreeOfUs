            ...
            if show {
                ...
                VStack(alignment: .center, spacing: 0) {
                    ...
                    HStack{
                        ...
                        Image(systemName: systemName).resizable().frame(width: 100, height: 100, alignment: Alignment.center).padding()
...
struct PopUpWindow_Previews: PreviewProvider {
    static var previews: some View {
        PopUpWindow(title:"title",message:"message",systemName: "pencil",buttonText: "OK", show: .constant(true))
    }
}
